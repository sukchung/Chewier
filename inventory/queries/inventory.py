...
class FoodBrandRepository:
    def create(self, food_brand: FoodBrandIn) -> FoodBrandOut:
    ...
    def update(self, food_brand_id: int, food_brand: FoodBrandIn) -> Union[FoodBrandOut, Error]:
        try:
            with pool.connection() as conn:
                with conn.cursor() as db:
                    db.execute(
            ...
            #print(e)
            return {"message": "Could not update that food brand.  Please check your input information, and try again."}

    def delete(self, food_brand_id: int) -> bool:
        try:
            with pool.connection() as conn:
                with conn.cursor() as db:
                    db.execute(
...
class FoodProductRepository:
    ...
    def get_all_food_products(self) -> Union[List[FoodProductOut], Error]:
        try:
            ...
            return {"message": "Could not retrieve all food products.  Please try your request again"}

    def update(self, food_product_id: int, food_product: FoodProductIn) -> Union[FoodProductOut, Error]:
        try:
            with pool.connection() as conn:
                with conn.cursor() as db:
                    db.execute(
